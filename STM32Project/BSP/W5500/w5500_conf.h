...
/*定义SPI2作为W5500的硬件接口*/
#define WIZ_SCLK                       GPIO_Pin_13     //PB13              
#define WIZ_SCLK_GPIO_PORT             GPIOB                        
#define WIZ_SCLK_GPIO_RCC              RCC_APB2Periph_GPIOB

#define WIZ_MISO                       GPIO_Pin_14      //PB14               
#define WIZ_MISO_GPIO_PORT             GPIOB                         
#define WIZ_MISO_GPIO_RCC               RCC_APB2Periph_GPIOB

#define WIZ_MOSI                       GPIO_Pin_15       //PB15             
#define WIZ_MOSI_GPIO_PORT             GPIOB                         
#define WIZ_MOSI_GPIO_RCC              RCC_APB2Periph_GPIOB


#define WIZ_SCS                        GPIO_Pin_12        //PB12            
#define WIZ_SCS_GPIO_PORT              GPIOB                          
#define WIZ_SCS_GPIO_RCC               RCC_APB2Periph_GPIOB
/*定义W5500的RESET管脚*/
#define WIZ_RESET                        GPIO_Pin_1        //PB1            
#define WIZ_RESET_GPIO_PORT              GPIOB                          
#define WIZ_RESET_GPIO_RCC               RCC_APB2Periph_GPIOB
	/*定义W5500的INT管脚*/
#define WIZ_INT                        GPIO_Pin_0        //PB0            
#define WIZ_INT_GPIO_PORT              GPIOB                          
#define WIZ_INT_GPIO_RCC               RCC_APB2Periph_GPIOB
